...
import com.mycompany.connect.work.api.servicios.reportes.ReportesService;
...
public class ReportesResource extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            Object reporte = service.generarReporte(request);
            resp.setStatus(HttpServletResponse.SC_OK);
            escritor.escribirJsonConFecha(resp, reporte);
